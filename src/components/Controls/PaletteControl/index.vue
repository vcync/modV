<template>
  <div class="palette-control" :data-moduleName="moduleName">
    <div class="pure-control-group">
      ...
      <draggable v-model="colors" :options="dragOptions" class="palette">
        <div
      ...
      <div class="pure-form-message-inline">
        <button class="pure-button" @click="togglePicker">
    ...
    <div class="picker-wrapper">
      <sketch-picker v-show="showPicker" v-model="pickerColors" />
    </div>
    ...
    <div v-show="useBpmInput" class="pure-control-group">
    ...
    <div class="pure-control-group">
      ...
      ></palette-selector>
      <div class="pure-form-message-inline">
        <button class="pure-button" @click="clickLoadPalette">Load</button>
      </div>
    </div>
    <div class="pure-control-group">
      <label :for="`${inputId}-save-palette`">Save Palette</label>
      <input
        :id="`${inputId}-save-palette`"
        v-model="savePaletteNameInput"
        type="text"
      />
      <div class="pure-form-message-inline">
        <button class="pure-button" @click="clickSavePalette">Save</button>
      </div>
    </div>
  </div>
</template>

<template>
  <keep-alive>
    <transition name="fade">
      <ul v-if="visible" ref="menu" class="nwjs-menu contextmenu">
        <component
          :is="'contextMenuItem'"
          ...
          :parent-offset-width="offsetWidth"
          :parent-offset-height="offsetHeight"
          :parent-position="{ x: options.x, y: options.y }"
          :index="idx"
        ></component>
      </ul>
    </transition>

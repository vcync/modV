...
import Arrow from "../assets/graphics/Arrow.svg?url";
import { GroupContextMenu } from "../menus/context/groupContextMenu.js";
...
export default {
  ...
  computed: {
    ...
    lastFocusedGroup() {
      return this.$store.state["uiGroups"].lastFocused === this.groupId;
    },
  ...
  methods: {
    ...
    focus() {
      ...
      this.$store.commit("uiGroups/SET_LAST_FOCUSED", this.groupId);
    },
    ...
    removeModule(moduleId) {
      ...
      if (this.focused) {
        this.$store.commit("uiGroups/CLEAR_LAST_FOCUSED");
      }
    },

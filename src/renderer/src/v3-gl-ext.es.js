...
const Ee = Symbol(
  ...
  Re = Symbol(process.env.NODE_ENV !== "production" ? "router" : "");
        ...
        re(
          ...
          ([n, u, s], [C, f]) => {
            u &&
              ...
              n &&
                u && // if there is no instance but to and from are the same this might be
                // the first visit
                (!f || !Ce(u, f) || !C) &&
                (u.enterCallbacks[s] || []).forEach((k) => k(n));
          },
          { flush: "post" },
        ),
        () => {
          const n = w.value,
            ...
            s = p.value,
            C = s && s.components[u];
          if (!C) return F(t.default, { Component: C, route: n });
          const f = s.props[u],
            g = f
              ? f === !0
                ? n.params
...
const Se = { style: { display: "none" } },
  ...
  Ge = /* @__PURE__ */ D({
    ...
    setup(e) {
      ...
      return (
        ie(() => (a = t.resolve(r.route))),
        () => (I(), $(B(Ve), { route: B(a) }, null, 8, ["route"]))
      );
    },
  }),
  Le = { style: { position: "relative" } },
  Oe = { style: { position: "absolute", width: "100%", height: "100%" } },
  De = /* @__PURE__ */ D({
    __name: "GoldenLayout",
    props: {
      config: {
    ...
    setup(e, { expose: r, emit: t }) {
      ...
      a.router &&
        f.afterEach((i) => {
          ...
          if (m && m !== "/")
            if (C[m]) {
              const v =
                (c = Array.from(_.entries()).find(
                  ([, E]) => E.refId === C[i.fullPath],
                )) == null
                  ? void 0
                  : c[0];
              v && v.focus(!0);
      ...
      const L = async (i, m) => {
          ...
          if (!c)
            throw new Error(
              `addComponent: Component '${i}' not found in slots`,
            );
          let v = k;
          return (
            y.length > 0 ? (v = y.pop()) : k++,
            p.value.set(v, () => c(m)),
            a.router && i === "route" && (C[m.url] = v),
            v
          );
        },
        ...
        O = async (i) => {
          ...
          let c = [m.root.content],
            v = 0;
          for (; c.length > 0; ) {
            const b = c.shift();
            for (let E of b)
              E.type == "component"
                ? ((v = await L(E.componentType, E.componentState)),
                  typeof E.componentState == "object"
                    ? (E.componentState.refId = v)
                    : (E.componentState = { refId: v }))
                : E.content.length > 0 && c.push(E.content);
          }
      ...
      return (
        ae(() => {
          ...
          const m = () => {
            ...
            E = (o, l) => {
              let d = -1;
              if (l && l.componentState) d = l.componentState.refId;
              else
                throw new Error(
                  "bindComponentEventListener: component's ref id is required",
                );
              const h = G.value + d,
                N = n == null ? void 0 : n.refs[h];
              return (
                _.set(o, { refId: d, glc: N[0] }),
                (o.virtualRectingRequiredEvent = (V, x, j) => c(V, x, j)),
                (o.virtualVisibilityChangeRequiredEvent = (V, x) => v(V, x)),
            ...
            ne = (o) => {
              ...
              _.delete(o),
                p.value.delete(l.refId),
                y.push(l.refId),
                Object.entries(C).find(([d, h]) =>
                  h === l.refId ? (delete C[d], !0) : !1,
                );
            };
          (g = new fe(w.value, E, ne)),
            a.router &&
              g.on("activeContentItemChanged", (o) => {
                var d;
                let l =
                  o.componentType === "route"
                    ? (d = o.container.state) == null
                      ? void 0
                      : d.url
                    : "/";
                f.currentRoute.value.fullPath !== l && f.replace(l);
              }),
            (g.beforeVirtualRectingEvent = m),
            g.on("stateChanged", () => {

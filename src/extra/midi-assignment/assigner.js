        ...
        navigator
          ...
          .catch(() => {
            Vue.$dialog.alert({
              ...
              message: `MIDI access was refused.
Please check your MIDI permissions for modV and refresh the page`,
              type: "is-danger",
              hasIcon: true,
              icon: "times-circle",
              iconPack: "fa"
        ...
        Vue.$dialog.alert({
          ...
          message: `Unfortunately your browser does not support WebMIDI,
please update to the latest Google Chrome release`,
          type: "is-danger",
          hasIcon: true,
          icon: "times-circle",
          iconPack: "fa"
    ...
    handleInput(message) {
      ...
      if (this.learning) {
        this.set(midiChannel, {
          deviceId: id,
          variable: this.toLearn,
          value: null
        });
        Vue.$toast.open({

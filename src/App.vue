<template>
  <div id="app">
    <section class="section">
      <div class="top">
        <div class="columns is-gapless is-mobile">
          <div class="column is-3 active-list-wrapper">
            <!-- 1-5 -->
          ...
          <div class="column gallery-wrapper">
            <!-- 4-5 -->
      ...
      <div v-bar="{ useScrollbarPseudo: true }" class="bottom">
        <div class="bottom-inner columns is-gapless is-mobile is-multiline">
          <div class="column is-9">
            <div
              class="control-panel-wrapper columns is-gapless is-mobile module-controls-wrapper"
            >
          ...
          <div class="column is-3 main-control-area">
            <div
              class="control-panel-wrapper columns is-gapless is-mobile layer-controls-wrapper"
            >
    ...
    <side-menu :menu-state="menuOpen"></side-menu>
